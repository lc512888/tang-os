...
from tang_os.version import MANIFEST, AUTHOR, CONTACT_EMAIL
...
class SystemDescriptor:
    ...
    def _build(self) -> SystemDescription:
        ...
        # Verification remains unknown unless a dated external report is attached.
        # Importing the runtime must never execute tests or manufacture evidence.
